...
const TEACHER_TYPES = ['CONVENER', 'FOREIGN', 'FOREIGN_COUNSELLOR', 'LOCAL_ADVISOR', 'LOCAL_COUNSELLOR', 'STAFF', 'FULL_TIME', 'PART_TIME'] as const
const TYPE_LABELS: Record<string, string> = {
  CONVENER:           '召集人',
  FOREIGN:            '外籍英語教學顧問',
  FOREIGN_COUNSELLOR: '外籍英語教學輔導員',
  LOCAL_ADVISOR:      '中籍英語教學顧問',
  LOCAL_COUNSELLOR:   '中籍英語教學輔導員',
  STAFF:              '行政團隊',
  FULL_TIME:          '專任教師',
  PART_TIME:          '兼任教師',
}
