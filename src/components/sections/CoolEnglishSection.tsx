      ...
      <Reveal>
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-[#9FE1CB] bg-[#E1F5EE]">
          <div className="grid items-center gap-8 px-7 py-10 md:grid-cols-[auto_1fr_auto] md:px-12 md:py-12">
            ...
            <a href={coolEnglishUrl} target="_blank" rel="noopener noreferrer" className="inline-flex flex-shrink-0 items-center justify-center gap-2 rounded-full border border-[#5DCAA5] bg-[#E1F5EE] px-6 py-3.5 text-sm font-semibold text-[#085041] transition hover:bg-[#9FE1CB]">
