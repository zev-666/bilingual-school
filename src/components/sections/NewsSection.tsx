    ...
    <section className="section-padding bg-sky-50">
      <div className="container-school">
        <div className="flex items-end justify-between mb-10">
          <div>
            <h2 className="text-3xl font-bold text-slate-800 mb-2 tracking-tight">{t('title')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {announcements.map((item) => (
            <Link key={item.id} href={`/news/${item.slug}` as any} className="card p-6">
              ...
              <h3 className="font-semibold text-slate-800 line-clamp-2 mb-3">
