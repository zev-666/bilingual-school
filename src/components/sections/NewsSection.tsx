        ...
        <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <Reveal>
            <Link
              ...
              className="group relative block min-h-[280px] overflow-hidden rounded-[2rem] border border-[#EDE6BE] bg-[#F6F8E3] p-7 shadow-[0_8px_24px_rgba(124,134,34,.10)] transition hover:-translate-y-1 sm:p-9"
            >
              ...
              return (
                <Reveal key={item.id} delay={index * 0.1}>
                  <Link
                    ...
                    className={`group block rounded-[2rem] border border-[#D7E3EF] ${style.bg} p-6 transition hover:-translate-y-1`}
                  >
                    <div className="flex items-center justify-between text-xs text-[#6B87A0]">
